...
export default function LandingPage({ 
  ...
  const faqList = [
    ...
    {
      q: "🔍 回報的資料會怎麼被使用？真的有用嗎？",
      a: "非常有用！所有收集到的災情點位、受災深度與現場照片，都將由政大國土服務團進行空間分析與實證研究，並主動彙整提報給經濟部水利署、行政院農委會水保局等防救災決策單位，以及馬太鞍、太巴塱部落會議，作為部落防汛疏散、溪流整治與災害補償規劃的實證參考依據。"
    },
    {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          我們是來自國立政治大學的熱血青年團隊，深耕花蓮部落。我們相信，透過「參與式地理資訊系統（PPGIS）」，能將居民切身的災害經驗轉化為客觀、強大的空間證據。我們致力於將學術所學投入社會實踐，守護原鄉的土地與安全。
        </p>
      </section>
